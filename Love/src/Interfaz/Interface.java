...
public class Interface extends JFrame {
	 ...
	 */
	public Interface() {
		setIconImage(Toolkit.getDefaultToolkit().getImage("E:\\Hobby\\Love\\Images\\icono7.png"));
		setResizable(false);
		...
		lblTitulo.setBounds(132, 11, 319, 58);
		...
		btnNo.setFont(new Font("Times New Roman", Font.BOLD, 25));
		...
		btnSi.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				 ...
				 JOptionPane.showMessageDialog(null, "UFFF QUE RICURA... ME ENCANTAS!!");
			}
		});
		btnSi.setFont(new Font("Times New Roman", Font.BOLD, 25));
